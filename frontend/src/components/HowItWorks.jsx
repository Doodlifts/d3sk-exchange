    ...
    <div className="min-h-screen bg-d3sk-bg text-d3sk-text">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          <div className="pixel-window border-4 border-d3sk-green shadow-pixel mb-8 inline-block">
            <div className="pixel-window-title bg-d3sk-green text-d3sk-bg">
              <span className="text-pixel-sm font-pixel">D3SK PROTOCOL MANUAL</span>
            </div>
            <div className="pixel-window-body bg-d3sk-bg p-6">
              <h1 className="pixel-heading text-d3sk-green crt-glow text-pixel-3xl">
                HOW D3SK WORKS
              </h1>
              <p className="font-retro text-d3sk-cyan max-w-2xl mx-auto mt-3 text-retro-base">
      ...
      <section className="px-4 sm:px-6 md:px-12 py-12 max-w-5xl mx-auto">
        <div className="pixel-window border-3 border-d3sk-red shadow-pixel mb-6">
          <div className="pixel-window-title bg-d3sk-red text-d3sk-bg">
            <span className="text-pixel-sm font-pixel">THE PROBLEM</span>
          </div>
          <div className="pixel-window-body bg-d3sk-bg p-6">
            <p className="font-retro text-d3sk-text mb-4 text-retro-base leading-relaxed">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-2 text-center md:text-left">
                <div className="flex-1">
                  <div className="bg-d3sk-green/20 border border-d3sk-green p-3">
                    <p className="font-retro text-retro-base text-d3sk-green font-bold">USER</p>
                  </div>
                </div>
                <div className="text-d3sk-muted font-retro text-retro-lg">→</div>
                <div className="flex-1">
                  <div className="bg-d3sk-yellow/20 border border-d3sk-yellow p-3">
                    <p className="font-retro text-retro-base text-d3sk-yellow font-bold">DEPOSIT</p>
                  </div>
                </div>
                <div className="text-d3sk-muted font-retro text-retro-lg">→</div>
                <div className="flex-1">
                  <div className="bg-d3sk-red/20 border border-d3sk-red p-3">
                    <p className="font-retro text-retro-base text-d3sk-red font-bold">POOL</p>
                  </div>
                </div>
                <div className="text-d3sk-muted font-retro text-retro-lg">→</div>
                <div className="flex-1">
                  <div className="bg-d3sk-red/30 border border-d3sk-red p-3">
                    <p className="font-retro text-retro-base text-d3sk-red font-bold">RISK!</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="px-4 sm:px-6 md:px-12 py-12 max-w-5xl mx-auto">
        <div className="pixel-window border-3 border-d3sk-green shadow-pixel mb-6">
          <div className="pixel-window-title bg-d3sk-green text-d3sk-bg">
            <span className="text-pixel-sm font-pixel">THE SOLUTION</span>
          </div>
          <div className="pixel-window-body bg-d3sk-bg p-6">
            <p className="font-retro text-d3sk-text mb-4 text-retro-base leading-relaxed">
            ...
            <div className="bg-d3sk-surface border-2 border-d3sk-border rounded p-4 mt-4">
              <div className="flex flex-col md:flex-row items-center justify-between gap-2 text-center md:text-left">
                <div className="flex-1">
                  <div className="bg-d3sk-green/20 border border-d3sk-green p-3">
                    <p className="font-retro text-retro-base text-d3sk-green font-bold">MAKER</p>
                  </div>
                </div>
                <div className="text-d3sk-muted font-retro text-retro-lg">→</div>
                <div className="flex-1">
                  <div className="bg-d3sk-cyan/20 border border-d3sk-cyan p-3">
                    <p className="font-retro text-retro-base text-d3sk-cyan font-bold">OFFER</p>
                    <p className="text-retro-sm text-d3sk-muted font-retro mt-1">(IN WALLET)</p>
                  </div>
                </div>
                <div className="text-d3sk-muted font-retro text-retro-lg">→</div>
                <div className="flex-1">
                  <div className="bg-d3sk-yellow/20 border border-d3sk-yellow p-3">
                    <p className="font-retro text-retro-base text-d3sk-yellow font-bold">TAKER</p>
                  </div>
                </div>
                <div className="text-d3sk-muted font-retro text-retro-lg">→</div>
                <div className="flex-1">
                  <div className="bg-d3sk-green/20 border border-d3sk-green p-3">
                    <p className="font-retro text-retro-base text-d3sk-green font-bold">SWAP!</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="text-center mb-8">
          <div className="pixel-window border-3 border-d3sk-cyan shadow-pixel inline-block">
            <div className="pixel-window-title bg-d3sk-cyan text-d3sk-bg">
              <span className="text-pixel-sm font-pixel">STEP BY STEP</span>
            </div>
            <div className="pixel-window-body bg-d3sk-bg p-4">
              <h2 className="pixel-heading text-d3sk-cyan text-pixel-xl">HOW IT WORKS</h2>
            </div>
          </div>
        </div>
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="pixel-window-title" style={{
                ...
                <span className="text-pixel-sm font-pixel">{step.number}. {step.title}</span>
              </div>
              <div className="pixel-window-body bg-d3sk-bg p-4">
      ...
      <section className="px-4 sm:px-6 md:px-12 py-12 max-w-5xl mx-auto">
        <div className="text-center mb-8">
          <div className="pixel-window border-3 border-d3sk-red shadow-pixel inline-block">
            <div className="pixel-window-title bg-d3sk-red text-d3sk-bg">
              <span className="text-pixel-sm font-pixel">WHY CADENCE?</span>
            </div>
            <div className="pixel-window-body bg-d3sk-bg p-4">
              <h2 className="pixel-heading text-d3sk-red text-pixel-xl">WHY NOT ETHEREUM?</h2>
            </div>
          </div>
        </div>
          ...
          {whyOnlyCadence.map((item, index) => (
            <div key={index} className="pixel-window border-2 border-d3sk-accent shadow-pixel">
              <div className="pixel-window-title bg-d3sk-accent text-d3sk-bg">
                <span className="text-pixel-sm font-pixel">{item.title}</span>
              </div>
              <div className="pixel-window-body bg-d3sk-bg p-4">
        ...
        <div className="text-center mb-8">
          <div className="pixel-window border-3 border-d3sk-yellow shadow-pixel inline-block">
            <div className="pixel-window-title bg-d3sk-yellow text-d3sk-bg">
              <span className="text-pixel-sm font-pixel">COMPARISON</span>
            </div>
            <div className="pixel-window-body bg-d3sk-bg p-4">
              <h2 className="pixel-heading text-d3sk-yellow text-pixel-xl">DEX VS D3SK</h2>
            </div>
          </div>
        </div>
          ...
          <table className="w-full border-collapse pixel-table">
            <thead>
              <tr className="border-b-2 border-d3sk-border bg-d3sk-surface">
                <th className="text-left py-3 px-4 font-pixel text-pixel-sm text-d3sk-green">FEATURE</th>
                <th className="text-left py-3 px-4 font-pixel text-pixel-sm text-d3sk-muted">TRADITIONAL DEX</th>
                <th className="text-left py-3 px-4 font-pixel text-pixel-sm text-d3sk-green">D3SK</th>
              </tr>
            </thead>
            <tbody>
              {comparison.map((row, index) => (
                ...
                >
                  <td className="py-3 px-4 font-pixel text-pixel-sm text-d3sk-text">{row.feature}</td>
                  <td className="py-3 px-4 font-retro text-retro-sm text-d3sk-muted">{row.traditional}</td>
                  <td className="py-3 px-4 font-retro text-retro-sm text-d3sk-green">{row.d3sk}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <section className="px-4 sm:px-6 md:px-12 py-12 max-w-4xl mx-auto text-center">
        <div className="pixel-window border-4 border-d3sk-green shadow-pixel">
          <div className="pixel-window-title bg-d3sk-green text-d3sk-bg">
            <span className="text-pixel-sm font-pixel">READY TO TRADE?</span>
          </div>
          <div className="pixel-window-body bg-d3sk-bg p-6">
            <p className="pixel-heading text-d3sk-green mb-4 crt-glow text-pixel-xl">START NOW</p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button className="btn-primary px-6 py-3 font-pixel text-pixel-sm shadow-pixel hover:translate-y-0.5 transition-all">
                CREATE OFFER
              </button>
              <button className="btn-secondary px-6 py-3 font-pixel text-pixel-sm shadow-pixel hover:translate-y-0.5 transition-all">
                VIEW ORDERBOOK
              </button>
            </div>
          </div>
